package com.bianca.systemui.keyguard;
...
public class BiancaKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    private static final String TAG = "BiancaKeyguardSliceProvider";
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KryptonKeyguardSliceProvider> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KryptonKeyguardSliceProvider kryptonKeyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(kryptonKeyguardSliceProvider);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = kryptonKeyguardSliceProvider.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KryptonKeyguardSliceProvider kryptonKeyguardSliceProvider;
            synchronized (this) {
                this.mWeatherCard.setIcon(bitmap);
                kryptonKeyguardSliceProvider = this.mProviderReference.get();
            }
            if (kryptonKeyguardSliceProvider != null) {
                kryptonKeyguardSliceProvider.notifyChange();
            }
        }
